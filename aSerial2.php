...
//slideShow();
   formularioI("Agregar Serial de Titulo a Estudiante", "aSerial();","funciones/bd_acciones.php","10");
   ?>
    ...
    <div class="row">
      ...
      <div id="serial1D" class="large-3 columns">
                  <input name="serial1" id="serial1" type="text" placeholder="Indique..." maxlength="2" onkeypress="return soloLetras(event);">
        <small id="serial1E" class="hidden-field">Campo Obligatorio</small>
      </div>
      <div id="serial2D" class="large-9 columns">
          
        <input name="serial2" id="serial2" type="text" placeholder="Indique..." onkeypress="return solonumeros(event);">
...
<button name="acciones" value="aSerial" class="button radius right">Agregar Serial</button> 
