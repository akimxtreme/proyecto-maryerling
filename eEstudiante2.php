...
//slideShow();
   formularioI("Eliminar Estudiante", "","funciones/bd_acciones.php","10");
   ?>
...
<button name="acciones" value="eEstudiante" class="button radius alert right">Eliminar Estudiante</button> 
