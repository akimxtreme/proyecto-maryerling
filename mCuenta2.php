...
//slideShow();
   formularioI("Modificar Cuenta de Usuario", "aCuenta();","funciones/bd_acciones.php","10");
   ?>
   ...
   <div class="row">
    <div id="usuarioD" class="large-6 columns">
            ...
            <input name="usuario" id="usuario" type="text" placeholder="Indique..." maxlength="15" value="<?php echo $usuario; ?>">
...
<button name="acciones" value="mCuenta" class="button radius alert right">Modificar Cuenta</button> 
