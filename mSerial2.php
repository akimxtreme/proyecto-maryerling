...
//slideShow();
   formularioI("Modificar Serial de Titulo del Estudiante", "aSerial();","funciones/bd_acciones.php","10");
   ?>
   	<h6><small class="rojo right">( * ) Campo Obligatorio</small></h6>
    
    <div class="row">
    	<div id="serialD" class="large-12 columns">
    	<span data-tooltip class="has-tip tip-top" title="Ingrese el Serial de Título asociado al Estudiante <br>Ej: AA16713354<br>Nota: Los 1eros 2 (dos) digitos son letras (Ej: AA) y los demás numericos (Ej: 12345)">
          <label id="serialL">
               <span class="radius secondary label">? </span>
                   <strong class="rojo"> * </strong>
          Serial del Título Asociado al Estudiante
          </label>
          </span>
		</div>
      <div id="serial1D" class="large-3 columns">
                  <input name="serial1" id="serial1" type="text" placeholder="Indique..." maxlength="2" onkeypress="return soloLetras(event);" value="<?php echo substr($serial, 0, 2);?>">
        <small id="serial1E" class="hidden-field">Campo Obligatorio</small>
      </div>
      <div id="serial2D" class="large-9 columns">
          
        <input name="serial2" id="serial2" type="text" placeholder="Indique..." onkeypress="return solonumeros(event);" value="<?php echo substr($serial, 2);?>">
        <small id="serial2E" class="hidden-field">Campo Obligatorio</small>
      </div>
   </div>
   ...
   <div class="row">   
    ...
    <div class="row">   
        ...
        <div class="row">
        	<div class="large-2 columns">
        		<select name="nacionalidad" id="nacionalidad" class="large-12" disabled="disabled">
					...
					$query = mysql_query($sql,$conexion);
						while ($row = mysql_fetch_array($query)){
							$cod_nacionalidad_2 = $row[0];
							$nacionalidad = $row[1];
							echo '<option value="'. $cod_nacionalidad_2 .'">'. $nacionalidad .'</option>';
						}
					?>
          		</select>
            </div>
      ...
      <div id="sexoD" class="large-6 columns">
          ...
          <select name="sexo" id="sexo" class="large-12" disabled="disabled">
    ...
    <div class="row">
      <div id="" class="large-6 columns">
         ...
         <select name="anio" id="anio" class="large-12" disabled="disabled">
        ...
        <div id="mesD" class="large-4 columns">
         <select name="mes" id="mes" class="large-12" disabled="disabled">
        ...
        <div id="diaD" class="large-4 columns">
         <select name="dia" id="dia" class="large-10" disabled="disabled">
      ...
      <div id="telefonoD" class="large-6 columns">
        ...
        <input name="telefono" id="telefono" type="text" placeholder="Indique..." onkeypress="return solonumeros(event);" maxlength="11" value="<?php echo $telefono;  ?>" disabled="disabled">
   ...
   <div class="row">
      <div id="colegioD" class="large-12 columns">
          ...
          Colegio de donde Egresó el Estudiante
       	...
       	<select name="colegio" id="colegio" class="large-12" disabled="disabled">
    ...
    <input type="hidden" name="cedula_id" value="<?php echo $cedula ?>" />
    <input type="hidden" name="nacionalidad_id" value="<?php echo $cod_nacionalidad ?>" />
      
<button name="acciones" value="mSerial" class="button secondary radius right">Modificar Serial</button> 
