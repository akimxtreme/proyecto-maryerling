...
$sql = 'SELECT * FROM usuario WHERE usuario="'. $_POST["usuario"]. '" AND id<>'.$codigo_id;
			...
			while ($row = mysql_fetch_array($query)){
					...
					echo '<tr>
							  ...
							  <td>'. $privilegio .'</td>
							  <td><form action="eCuenta2.php" method="post"><input type="hidden" name="id" value="'. $id .'" /><button class="button alert secondary" name="acciones" value="eCuenta">Eliminar</button></form></td>
						</tr>
							';
			}
